...
class EmojisPerUser extends StatefulWidget {
  const EmojisPerUser({
    super.key,
  });

  @override
  State<EmojisPerUser> createState() => _EmojisPerUserState();
}

class _EmojisPerUserState extends State<EmojisPerUser> {
  ...
  Widget build(BuildContext context) {
    return ListContainer(
      children: [
        ...
        SfCartesianChart(
            title: const ChartTitle(text: "Emojis per user"),
